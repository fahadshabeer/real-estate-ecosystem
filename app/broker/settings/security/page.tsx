...
export default function BrokerSecuritySettingsPage() {
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="rounded-md border border-[#dbe4eb] bg-[#f8fafc] p-4">
            ...
            <div className="mt-3 space-y-2 text-sm">
              ...
              <button type="button" className="flex w-full items-center justify-between rounded-md border border-[#dbe4eb] bg-white px-3 py-2" onClick={() => toggle("newLoginAlert")}> 
                <span>New Device Login Alerts</span>
          ...
          <div className="rounded-md border border-[#dbe4eb] bg-[#f8fafc] p-4">
            ...
            <div className="mt-3 space-y-2">
              <input type="password" placeholder="Current password" value={passwordForm.current} onChange={(e) => setPasswordForm((p) => ({ ...p, current: e.target.value }))} className="h-11 w-full rounded-md border border-[#dbe4eb] bg-white px-3 text-sm" />
              <input type="password" placeholder="New password" value={passwordForm.next} onChange={(e) => setPasswordForm((p) => ({ ...p, next: e.target.value }))} className="h-11 w-full rounded-md border border-[#dbe4eb] bg-white px-3 text-sm" />
              <input type="password" placeholder="Confirm new password" value={passwordForm.confirm} onChange={(e) => setPasswordForm((p) => ({ ...p, confirm: e.target.value }))} className="h-11 w-full rounded-md border border-[#dbe4eb] bg-white px-3 text-sm" />
              <button type="button" className="inline-flex items-center gap-2 rounded-md bg-[#3aa4a8] px-4 py-2 text-sm font-semibold text-white" onClick={() => void changePassword()}>
