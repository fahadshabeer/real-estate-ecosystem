...
export default function BrokerBillingSettingsPage() {
  ...
  return (
    <div className="space-y-5 pb-6">
      ...
      {companyQuery.isLoading ? (
        <SettingsPageSkeleton rows={4} />
      ) : companyQuery.isError ? (
        <section className="rounded-md border border-[#f2d4d4] bg-[#fff6f6] p-4 text-sm text-[#b74444]">
          {(companyQuery.error as Error | undefined)?.message ?? "Unable to load billing details."}
        </section>
      ) : (
