      ...
      <section className="rounded-md border border-[#dbe4eb] bg-white p-5">
        <div className="grid gap-3 md:grid-cols-2">
          <label className="text-sm text-[#4f6078]">
            ...
            <FancySelect
              value={form.language}
              onChange={(e) => setField("language", e.target.value as "English" | "Arabic")}
          ...
          <label className="text-sm text-[#4f6078]">
            ...
            <FancySelect
              value={form.currency}
              onChange={(e) => setField("currency", e.target.value as "QAR" | "USD")}
              className="mt-1 h-11 w-full rounded-md border border-[#dbe4eb] bg-white px-3 text-sm text-[#1f2a44]"
            >
        ...
        <div className="mt-4 grid gap-2 text-sm">
          <button
            type="button"
            className="flex items-center justify-between rounded-md border border-[#dbe4eb] bg-[#f8fafc] px-3 py-2"
            onClick={() => setField("emailAlerts", !form.emailAlerts)}
          >
          ...
          <button
            type="button"
            className="flex items-center justify-between rounded-md border border-[#dbe4eb] bg-[#f8fafc] px-3 py-2"
            onClick={() => setField("dashboardAlerts", !form.dashboardAlerts)}
          >
